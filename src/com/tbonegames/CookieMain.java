...
public class CookieMain {
	...
	int cookieCounter, timerSpeed, cursorNumber, cursorPrice, grandpaNumber, grandpaPrice, grandmaPrice, grandmaNumber, elvesPrice, elvesNumber;
	double perSecond;
	boolean timerOn, grandpaUnlocked, grandmaUnlocked, elvesUnlocked;
	Font font1, font2;
